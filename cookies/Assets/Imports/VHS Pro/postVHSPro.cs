...
public class postVHSPro : MonoBehaviour {
	...
	void CreateMaterials(){
	 ...
	 //     if(bypassTex!=null && bypassTex is VideoPlayer) {
  //          ((VideoPlayer)bypassTex).loop = true;
  //          ((VideoPlayer)bypassTex).Play();
	 //     }	
  //    #endif			
	...
	void OnRenderImage (RenderTexture src, RenderTexture dest) {		
		...
		if(spriteTex!=null) 	bypassTex = (Texture)spriteTex.texture;
